...
const mapStateToProps = state => ({ ...state.eatuserorders });
var UserName = "Order List";
const mapDispatchToProps = dispatch => ({
    onGetOrders: (data) =>
        dispatch({ type: ORDERS_ALL_LIST, payload: AxiosRequest.Eat.getOrdersforUser(data) }),
...
class EatUserOrdersPage extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            selectedPage: 1,
    ...
    onFiltersApply(vId, search,page,moveitfilter) {
        ...
        var filter = {userid:Userid,search: search ,page:page,delivery_vendor:moveitfilters};
...
export default connect(mapStateToProps, mapDispatchToProps)(EatUserOrdersPage);