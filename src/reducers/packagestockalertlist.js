import { PACKAGE_STOCK_LIST_ALERT_FILTER, PACKAGE_STOCK_ALERT_LIST} from '../constants/actionTypes';

export default (state = {packagestockarray:[],search:'',page:1,totalStockArrayCount:0,stockLimt:10}, action) => {
  switch (action.type) {
    case PACKAGE_STOCK_ALERT_LIST:
      return {
        ...state,
      ...
      case PACKAGE_STOCK_LIST_ALERT_FILTER:
      return{
        ...state,
